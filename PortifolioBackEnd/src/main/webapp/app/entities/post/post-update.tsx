  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          abukarUser: postEntity?.abukarUser?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="portfolioApp.post.home.createOrEditLabel" data-cy="PostCreateUpdateHeading">
            <Translate contentKey="portfolioApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('portfolioApp.post.title')}
                id="post-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('portfolioApp.post.content')}
                id="post-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField
                label={translate('portfolioApp.post.date')}
                id="post-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              <ValidatedField
                ...
                name="abukarUser"
                data-cy="abukarUser"
                label={translate('portfolioApp.post.abukarUser')}
                type="select"
              >
                <option value="" key="0" />
                {abukarUsers
