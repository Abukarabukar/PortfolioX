...
export const PostDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/post' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="portfolioApp.post.delete.question">
        <Translate contentKey="portfolioApp.post.delete.question" interpolate={{ id: postEntity.id }}>
