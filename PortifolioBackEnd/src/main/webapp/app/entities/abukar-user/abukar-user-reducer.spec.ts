...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ABUKARUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ABUKARUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ABUKARUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ABUKARUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ABUKARUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ABUKARUSER actions', async () => {
      const arg = 42666;
