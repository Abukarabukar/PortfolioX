...
export const PhotoDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/photo' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="portfolioApp.photo.delete.question">
        <Translate contentKey="portfolioApp.photo.delete.question" interpolate={{ id: photoEntity.id }}>
