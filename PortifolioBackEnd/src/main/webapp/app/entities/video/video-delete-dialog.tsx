...
export const VideoDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/video' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="portfolioApp.video.delete.question">
        <Translate contentKey="portfolioApp.video.delete.question" interpolate={{ id: videoEntity.id }}>
