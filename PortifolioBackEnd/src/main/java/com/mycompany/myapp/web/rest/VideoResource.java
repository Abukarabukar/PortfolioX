...
public class VideoResource {
    ...
    public ResponseEntity<Video> createVideo(@Valid @RequestBody Video video) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/videos/" + video.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, video.getId().toString()))
            .body(video);
    }
