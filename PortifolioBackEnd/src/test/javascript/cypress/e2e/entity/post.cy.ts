...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'hatbox burden how', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-07-11T01:08:18.594Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('brightly');
      cy.get(`[data-cy="title"]`).should('have.value', 'brightly');
      ...
      cy.get(`[data-cy="date"]`).type('2024-07-11T13:44');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-07-11T13:44');
